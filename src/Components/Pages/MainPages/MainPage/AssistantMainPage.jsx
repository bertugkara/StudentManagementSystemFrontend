...
import AssistantEditLesson from "../../Lesson/EditComponents/AssistantEditLesson";

export default function AssistantMainPage(props) {

    const [Component, setComponent] = useState(<AssistantMainPage />);
    const [isEditing, setIsEditing] = useState(false);

    function handleEditButton(lesson) {
        setComponent(<AssistantEditLesson lesson={lesson} />);
        setIsEditing(true);
    }
